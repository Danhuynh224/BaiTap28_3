...
import com.example.fragmenttablayoutandviewpager2.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.menuSearch) {
            ...
            return true;
        } else if (id == R.id.menuNewGroup || id == R.id.menuBroadcast ||
                id == R.id.menuWeb || id == R.id.menuMessage) {
